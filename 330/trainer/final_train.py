...
# have to hard code- number of words in the thing
...
def train_model_seara(train_file='test_pickle.pickle', **args):
	...
	# ---------------------- CNN single -----------------------
	convoluted_input_test=bag_of_words_conversion(X_test,region_size,convolution_stride,words,len_vocabulary)
	convoluted_input_train=bag_of_words_conversion(X_train,region_size,convolution_stride,words,len_vocabulary)
	...
	seq = ToDenseSeq(convoluted_input_train,y_train, 25)
